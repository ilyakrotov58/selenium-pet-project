...
public class MainPage {
    ...
    @FindBy(xpath = "//input[@name='business_name']") WebElement txtBusinessName;
    @FindBy(xpath = "//input[@name='email']") WebElement txtEmail;
    @FindBy(id = "demo") WebElement btnSubmit;
    @FindBy(id = "number") WebElement txtResultField;
    @FindBy(id = "numb1")
    static WebElement elemFirstNumber;
    @FindBy(id = "numb2")
    static WebElement elemSecondNumber;
    @FindBy(xpath = "//div[@class='completed']/h2/strong") WebElement successLabel;
